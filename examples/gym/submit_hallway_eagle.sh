...
#SBATCH --time=1:00:00
#SBATCH --job-name=hallway_example
# --- Policy Trainer ---
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
# --- MCTS Rollouts ---
...
export WORKING_DIR=/scratch/${USER}/rlmolecule/hallway/
...
python -u solve_hallway.py --train-policy
EOF
...
python -u solve_hallway.py --rollout
EOF
